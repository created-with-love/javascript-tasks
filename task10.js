...
const getSortedUniqueSkills = array =>
  [...array]
    .map(({ skills }) => skills) //фильтрую и оставляю только массивы скиллов
    .reduce((acc, val) => acc.concat(val), []) // убираю вложенность и распыляю все в один массив
    .sort() // сортирую в алфавитном порядке
    .filter((value, index, array) => {
      return array.indexOf(value) === index;
    }); // и под конец удаляю повторения таким незамысловатым фильтром
