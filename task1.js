...
// name = '«Генератор защитного поля»'; // Write code in this line
// price = 1000; // Write code in this line
// firstMessage = ``; // Write code in this line
// price = 2000;
// secondMessage = ``; // Write code in this line
